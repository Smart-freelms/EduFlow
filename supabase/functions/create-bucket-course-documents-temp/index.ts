...
Deno.serve(async (req) => {
    ...
    bucketConfig.allowed_mime_types = ["application/pdf", "application/msword", "application/vnd.openxmlformats-officedocument.wordprocessingml.document", "application/vnd.ms-powerpoint", "application/vnd.openxmlformats-officedocument.presentationml.presentation", "text/*"];
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for course-documents" ON storage.objects FOR SELECT USING (bucket_id = 'course-documents');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for course-documents" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'course-documents');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for course-documents" ON storage.objects FOR UPDATE USING (bucket_id = 'course-documents');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for course-documents" ON storage.objects FOR DELETE USING (bucket_id = 'course-documents');`
    ];
    ...
    return new Response(JSON.stringify({
        ...
        name: 'course-documents',
        public: true,
        allowed_mime_types: ["application/pdf", "application/msword", "application/vnd.openxmlformats-officedocument.wordprocessingml.document", "application/vnd.ms-powerpoint", "application/vnd.openxmlformats-officedocument.presentationml.presentation", "text/*"],
